        ...
        return(
            <div>
                ...
                <ul className="list">
                    ...
                    <a href="https://wip.chat/@1334" target="_blank" rel="noopener noreferrer"><li style={{color:'white'}} className="smaller">Work in Progress</li></a>
                    <a href="https://twitter.com/aviihej" target="_blank" rel="noopener noreferrer"><li style={{color:'white'}} className="smaller">Twitter</li></a>
                    ...
                    <br />
                    <li className="smaller"><a style={{color:'white'}} href="https://www.cannaboard.ca" target="_blank" rel="noopener noreferrer">Cannaboard.ca</a></li>
                    <br />
